...
struct FireworkParticle
{
    ...
    World_ParticleGS::World_ParticleGS()
    {
    ...
    void World_ParticleGS::createProceduralParticleSystem()
    {
    ...
    void World_ParticleGS::testCapabilities(const RenderSystemCapabilities* caps)
    {
        requireMaterial("Ogre/ParticleGS/Generate");
    }

    void World_ParticleGS::setupContent(void)
    {
    ...
    void World_ParticleGS::cleanupContent()
    {
...
#ifdef LOG_GENERATED_BUFFER
    bool World_ParticleGS::frameEnded(const FrameEvent& evt)
    {
        ...
        vertexBuffer->unlock();
        return SdkWorld::frameEnded(evt);
    }
#endif
}
