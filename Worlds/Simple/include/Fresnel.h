...
class _OgreWorldClassExport World_Fresnel : public SdkWorld, public RenderTargetListener
{
public:
    ...
    World_Fresnel() : NUM_FISH(30), NUM_FISH_WAYPOINTS(10), FISH_PATH_LENGTH(200), FISH_SCALE(2)
    {
        mInfo["Title"] = "Fresnel";
