...
class _OgreWorldClassExport World_Island : public SdkWorld
{
public:
    ...
    {
        mInfo["Title"] = "Island";
        mInfo["Description"] = "World for terrain, water tessellation and the use of displacement mapping";
    ...
    {
        OGRE_EXCEPT(Exception::ERR_NOT_IMPLEMENTED, "This world is not yet finished."
                " Sorry!", "World_Island::testCapabilities");
        ...
        {
            OGRE_EXCEPT(Exception::ERR_NOT_IMPLEMENTED, "Your card does not support the shader model 5.0 needed for this world, "
                "so you cannot run this world. Sorry!", "World_Island::testCapabilities");
        }
    }
...
protected:
    ...
    void cleanupContent()
    {
        // clean up properly to avoid interfering with subsequent worlds
    }
