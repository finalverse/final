#ifndef __DualQuaternion_World_H__
#define __DualQuaternion_World_H__
...
class _OgreWorldClassExport World_DualQuaternion : public SdkWorld
{
 public:
 World_DualQuaternion() : ent(0), entDQ(0), totalTime(0)
#if defined(INCLUDE_RTSHADER_SYSTEM) && defined(RTSHADER_SYSTEM_BUILD_EXT_SHADERS)
