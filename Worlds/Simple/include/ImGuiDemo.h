...
class _OgreWorldClassExport World_ImGui : public SdkWorld, public RenderTargetListener
{
public:
    // Basic constructor
    World_ImGui()
    ...
    void setupContent(void) override
    {
        ...
        /*
            ...
            OgreBites::Creator does this on behalf of the ImGuiDemo but custom applications will need to
