...
//------------------------------------------------------------------------------
World_NewInstancing::World_NewInstancing() : NUM_INST_ROW(50), NUM_INST_COLUMN(50), mCurrentManager(0), mCurrentMaterialSet(c_materialsTechniques), mCurrentFlags(0), mSkinningTechniques(NULL)
{
...
//------------------------------------------------------------------------------
bool World_NewInstancing::frameRenderingQueued(const FrameEvent& evt)
{
    ...
    return SdkWorld::frameRenderingQueued(evt);        // don't forget the parent class updates!
}

//------------------------------------------------------------------------------
bool World_NewInstancing::keyPressed(const KeyboardEvent& evt)
{
    ...
    return SdkWorld::keyPressed(evt);
}

//------------------------------------------------------------------------------
void World_NewInstancing::setupContent()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::setupLighting()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::switchInstancingTechnique()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::switchSkinningTechnique(int index)
{
    switch(index)
    {
        default:
...
//------------------------------------------------------------------------------
void World_NewInstancing::createEntities(int technique)
{
    std::mt19937 rng;
...
//------------------------------------------------------------------------------
void World_NewInstancing::createInstancedEntities()
{
    std::mt19937 rng;
...
//------------------------------------------------------------------------------
void World_NewInstancing::createSceneNodes()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::clearScene()
{
...
//-----------------------------------------------------------------------------------
void World_NewInstancing::destroyManagers()
{
    mSceneMgr->destroyInstanceManager(mCurrentManager);;
}

//------------------------------------------------------------------------------
void World_NewInstancing::cleanupContent()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::animateUnits( float timeSinceLast )
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::moveUnits( float timeSinceLast )
{
    Real fMovSpeed = 1.0f;
...
//------------------------------------------------------------------------------
Quaternion World_NewInstancing::lookAt( const Vector3 &normDir )
{
    return Math::lookRotation(normDir.normalisedCopy(), Vector3::UNIT_Y);
}

//------------------------------------------------------------------------------
void World_NewInstancing::defragmentBatches()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::setupGUI()
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::itemSelected( SelectMenu* menu )
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::buttonHit( OgreBites::Button* button )
{
    if( button == mDefragmentBatches ) defragmentBatches();
}

//------------------------------------------------------------------------------
void World_NewInstancing::checkBoxToggled( CheckBox* box )
{
...
//------------------------------------------------------------------------------
void World_NewInstancing::sliderMoved( Slider* slider )
{
...
void World_NewInstancing::checkHardwareSupport()
{
