...
The following example shows a different approach to rendering lights in RTSS. A few points on this system
    ...
    - World requires shader model 3 or higher to run in order
...
class _OgreWorldClassExport World_ShaderSystemMultiLight : public SdkWorld
{
