...
namespace OgreBites {
    ...
    void World_Isosurf::testCapabilities(const RenderSystemCapabilities* caps)
    {
        requireMaterial("Ogre/Isosurf/TessellateTetrahedra");
    }

    // Just override the mandatory create scene method
    void World_Isosurf::setupContent(void)
    {
    ...
    void World_Isosurf::cleanupContent()
    {
        MeshManager::getSingleton().remove(mTetrahedraMesh);
    }

    bool World_Isosurf::frameRenderingQueued(const FrameEvent& evt)
    {
