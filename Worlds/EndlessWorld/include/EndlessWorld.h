...
You may use this World code for anything you like, it is not covered by the
...
class _OgreWorldClassExport World_EndlessWorld : public SdkWorld
{
public:
    ...
    bool frameRenderingQueued(const FrameEvent& evt) override
    {
		...
		return SdkWorld::frameRenderingQueued(evt);  // don't forget the parent updates!
    }
...
protected:
	...
	/*-----------------------------------------------------------------------------
	| Extends setupView to change some initial camera settings for this World.
	-----------------------------------------------------------------------------*/
