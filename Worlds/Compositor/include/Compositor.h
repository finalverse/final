...
class _OgreWorldClassExport World_Compositor : public SdkWorld
{
 public:
    World_Compositor();
...
/*************************************************************************
                            World_Compositor Methods
*************************************************************************/
World_Compositor::World_Compositor()
{
...
void World_Compositor::setupView()
{
    SdkWorld::setupView();
...
void World_Compositor::setupContent(void)
{
...
void World_Compositor::registerCompositors(void)
{
...
void World_Compositor::changePage(size_t pageNum)
{
...
void World_Compositor::cleanupContent(void)
{
...
void World_Compositor::setupControls(void)
{
...
void World_Compositor::checkBoxToggled(OgreBites::CheckBox * box)
{
...
void World_Compositor::buttonHit(OgreBites::Button* button)
{
...
void World_Compositor::itemSelected(OgreBites::SelectMenu* menu)
{
...
void World_Compositor::setupScene(void)
{
...
bool World_Compositor::frameRenderingQueued(const FrameEvent& evt)
{
...
void World_Compositor::createEffects(void)
{
    /// Motion blur effect
...
void World_Compositor::createTextures(void)
{
    using namespace Ogre;
