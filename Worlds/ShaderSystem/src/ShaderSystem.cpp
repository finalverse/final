...
//-----------------------------------------------------------------------
World_ShaderSystem::World_ShaderSystem() :
...
void World_ShaderSystem::_shutdown()
{
...
void World_ShaderSystem::checkBoxToggled(CheckBox* box)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::itemSelected(SelectMenu* menu)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::buttonHit( OgreBites::Button* b )
{
...
//--------------------------------------------------------------------------
void World_ShaderSystem::sliderMoved(Slider* slider)
{
...
//-----------------------------------------------------------------------
bool World_ShaderSystem::frameRenderingQueued( const FrameEvent& evt )
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::setupContent()
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::setupUI()
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::cleanupContent()
{   
...
//-----------------------------------------------------------------------
void World_ShaderSystem::setCurrentLightingModel(ShaderSystemLightingModel lightingModel)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::setSpecularEnable(bool enable)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::setPerPixelFogEnable( bool enable )
{
#ifdef RTSHADER_SYSTEM_BUILD_EXT_SHADERS
...
void World_ShaderSystem::setAtlasBorderMode( bool enable )
{
#ifdef RTSHADER_SYSTEM_BUILD_EXT_SHADERS
...
//-----------------------------------------------------------------------
void World_ShaderSystem::updateSystemShaders()
{
...
void World_ShaderSystem::generateShaders(Entity* entity)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::createDirectionalLight()
{
    Light*  light;
    Vector3 dir;
...
//-----------------------------------------------------------------------
void World_ShaderSystem::createPointLight()
{
    Light*  light;
...
//-----------------------------------------------------------------------
void World_ShaderSystem::createSpotLight()
{
    Light*  light;
...
void World_ShaderSystem::addModelToScene(const String &  modelName)
{
...
void World_ShaderSystem::updateAddLotsOfModels(bool addThem)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::updateInstancedViewports(bool enabled)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::updateLightState(const String& lightName, bool visible)
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::applyShadowType(int menuIndex)
{
    // Grab the scheme render state.                                                
...
//-----------------------------------------------------------------------
void World_ShaderSystem::testCapabilities( const RenderSystemCapabilities* caps )
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::unloadResources()
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::pickTargetObject( const MouseButtonEvent &evt )
{
    int xPos   = evt.x;
    int yPos   = evt.y;
...
//-----------------------------------------------------------------------
void World_ShaderSystem::updateTargetObjInfo()
{
    if (mTargetObj == NULL)
        return;
...
//-----------------------------------------------------------------------
void World_ShaderSystem::changeTextureLayerBlendMode()
{
...
//-----------------------------------------------------------------------
bool World_ShaderSystem::mousePressed(const MouseButtonEvent& evt)
{
...
//-----------------------------------------------------------------------
bool World_ShaderSystem::mouseReleased(const MouseButtonEvent& evt)
{
...
//-----------------------------------------------------------------------
bool World_ShaderSystem::mouseMoved(const MouseMotionEvent& evt)
{
...
void World_ShaderSystem::destroyInstancedViewports()
{
...
//-----------------------------------------------------------------------
void World_ShaderSystem::destroyInstancedViewportsFactory()
{
...
void World_ShaderSystem::createInstancedViewports()
{
    if (mInstancedViewportsFactory == NULL)
    {
...
void World_ShaderSystem::createMaterialForTexture( const String & texName, bool isTextureAtlasTexture )
{
...
ManualObject* World_ShaderSystem::createTextureAtlasObject()
{
