...
class _OgreWorldClassExport InfiniteFrustum : public Frustum
{
public:
...
class _OgreWorldClassExport World_ShaderSystem : public SdkWorld
{
public:
    World_ShaderSystem();
    ~World_ShaderSystem();
...
//  virtual void setupView();
    ...
    /** @see World::setupContent. */
    void setupContent() override;

    /** Setup the UI for the world. */
    void setupUI();
    
    /** @see World::setupContent. */
    void cleanupContent() override;
    
    /** @see World::unloadResources. */
